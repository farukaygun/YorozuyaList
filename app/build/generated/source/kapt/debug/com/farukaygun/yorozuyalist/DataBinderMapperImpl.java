...
import com.farukaygun.yorozuyalist.databinding.ItemRankingRecyclerBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_ITEMRANKINGRECYCLER = 5;

  private static final int LAYOUT_ITEMSEASONALANIMERECYCLER = 6;

  private static final int LAYOUT_ITEMSUGGESTEDANIMERECYCLER = 7;

  private static final int LAYOUT_ITEMTODAYANIMERECYCLER = 8;
  ...
  static {
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.farukaygun.yorozuyalist.R.layout.item_ranking_recycler, LAYOUT_ITEMRANKINGRECYCLER);
  ...
  public ViewDataBinding getDataBinder(DataBindingComponent component, View view, int layoutId) {
    ...
    if(localizedLayoutId > 0) {
      ...
      switch(localizedLayoutId) {
        ...
        case  LAYOUT_ITEMRANKINGRECYCLER: {
          if ("layout/item_ranking_recycler_0".equals(tag)) {
            return new ItemRankingRecyclerBindingImpl(component, view);
          }
          throw new IllegalArgumentException("The tag for item_ranking_recycler is invalid. Received: " + tag);
        }
  ...
  private static class InnerBrLookup {
    ...
    static {
      ...
      sKeys.put(2, "rankingAnimeData");
      sKeys.put(3, "seasonalAnimeData");
      sKeys.put(4, "suggestedAnimeData");
    }
  }
  ...
  private static class InnerLayoutIdLookup {
    ...
    static {
      ...
      sKeys.put("layout/item_ranking_recycler_0", com.farukaygun.yorozuyalist.R.layout.item_ranking_recycler);
