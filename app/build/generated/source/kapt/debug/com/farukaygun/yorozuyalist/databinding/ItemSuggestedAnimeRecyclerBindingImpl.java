...
public class ItemSuggestedAnimeRecyclerBindingImpl extends ItemSuggestedAnimeRecyclerBinding implements com.farukaygun.yorozuyalist.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.listener == variableId) {
            ...
            setSuggestedAnimeData((com.farukaygun.yorozuyalist.model.anime.Node) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setSuggestedAnimeData(@Nullable com.farukaygun.yorozuyalist.model.anime.Node SuggestedAnimeData) {
    ...
    protected void executeBindings() {
        ...
        com.farukaygun.yorozuyalist.model.anime.Node suggestedAnimeData = mSuggestedAnimeData;
